    ...
    <div class="faq-page-content">
        <div class="question-content background-card" id="how-are-furnitures-chosen">
            ...
            <div class="sub-title gray-text-color">
                ...
                At the end, the application offers to view the result in 3D in the application, but
                also (and above all) in augmented reality directly in the room! At this stage, he can
                even move the furniture displayed, select others, delete or add them manually and change
        ...
        <div class="question-content background-card" id="where-are-models-from">
            ...
            <div class="sub-title gray-text-color">
                ...
                conversion solutions in order to be compatible with our service. In the worst case,
                we can adapt to them and offer support for additional formats according to the needs of our partners.
            </div>
        </div>
    </div>
</template>
