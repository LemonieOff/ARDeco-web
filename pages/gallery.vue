        ...
        <div class="title">Gallery</div>
            <div class="form">
                ...
                <div v-for="(item) in GalleryData"class="grid-row">
                        ...
                        <div class="grid-item" v-if="item.visibility === true" >{{ item.user.first_name }} {{ item.user.last_name }}</div>
                        <div class="grid-item">
                        <a :href="'/gallery/' + item.id" class="custom-button" v-if="item.visibility === true">Details</a>
                    </div>
                </div>
            </div>
        </div>
